...
<p>El día de hoy, {{ $fecha }}, a las {{ $hora }}, hemos recibido exitosamente su denuncia sobre {{ $tipo_denuncia }}. Esta denuncia ha sido asignada a un especialista quien le dará oportuna respuesta.</p>
